...
const AvatarInitials = styled(StyledBaseText)`
  font: normal normal 400 20px/20px
...
const ButtonLarge = styled(StyledBaseText)`
  font: normal normal 500 18px/32px
    ${({ theme }) => theme.typography.fontFamily};
...
const H1 = styled(StyledBaseText)`
  font: normal normal 500 96px/112.03px
    ${({ theme }) => theme.typography.fontFamily};
  letter-spacing: -1.5px;
`;

const H2 = styled(StyledBaseText)`
  font: normal normal 500 60px/72px
    ${({ theme }) => theme.typography.fontFamily};
  letter-spacing: -0.5px;
`;

const H3 = styled(StyledBaseText)`
  font: normal normal 500 48px/56px
    ${({ theme }) => theme.typography.fontFamily};
`;

const H4 = styled(StyledBaseText)`
  font: normal normal 500 34px/42px
    ${({ theme }) => theme.typography.fontFamily};
...
const InputLabel = styled(StyledBaseText)`
  font: normal normal 500 12px/12px
    ${({ theme }) => theme.typography.fontFamily};
  text-align-vertical: center;
`;
...
const Overline = styled(StyledBaseText)`
  font: normal normal 400 12px/32px
    ${({ theme }) => theme.typography.fontFamily};
  letter-spacing: 1px;
`;
...
const Tooltip = styled(StyledBaseText)`
  font: normal normal 500 10px/14px
    ${({ theme }) => theme.typography.fontFamily};
`;
...
const Subtitle1 = styled(StyledBaseText)`
  font: normal normal 500 16px/28px
    ${({ theme }) => theme.typography.fontFamily};
`;

const Subtitle2 = styled(StyledBaseText)`
  font: normal normal 500 14px/22px
    ${({ theme }) => theme.typography.fontFamily};
  text-align-vertical: top;
